...
[![cli version](https://img.shields.io/npm/v/toolcrib?label=cli)](https://npmjs.com/package/toolcrib)
[![cli downloads](https://img.shields.io/npm/dm/toolcrib?label=cli%20downloads)](https://npmjs.com/package/toolcrib)
[![mcp version](https://img.shields.io/npm/v/toolcrib-mcp?label=mcp)](https://npmjs.com/package/toolcrib-mcp)
[![mcp downloads](https://img.shields.io/npm/dm/toolcrib-mcp?label=mcp%20downloads)](https://npmjs.com/package/toolcrib-mcp)
...
- MCP uses the vendored source so it is always 100% accurate, not whatever is "in the registry"
...
- MCP and docs always exactly match what is installed
...
We introduce the **QoS Floor** where you apply a layer of functionality that ensures a certain Quality of Service (QoS) in the form of important UX axes and biased for AI model consumption.
